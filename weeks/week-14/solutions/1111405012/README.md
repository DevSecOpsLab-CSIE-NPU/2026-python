...
- [QUESTION-11349](targets/QUESTION-11349.md)
- [QUESTION-11417](targets/QUESTION-11417.md)
- [QUESTION-11461](targets/QUESTION-11461.md)
- [QUESTION-12019](targets/QUESTION-12019.md)

## 目錄結構

```markdown
weeks/week-14/solutions/1111405012
├── README.md                  # 作業說明
├── AI_USAGE.md                # AI 使用紀錄
...
### 單元測試
```bash
python -m unittest discover -s "weeks/week-14/solutions/1111405012/tests" -p "test_*.py" -v
```
