"""Stage 2 sorting correctness tests.

The checks are split into multiple cases, including an edge case,
and the same assertions are reused for all three sort functions.
"""
...
class TestSortFunctions(unittest.TestCase):
	...
	def test_sorts_basic_unsorted_list(self):
	...
	def test_sorts_edge_case_empty_list(self):
