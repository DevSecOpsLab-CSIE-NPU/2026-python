...
class Point:
    ...
    def __eq__(self, other):
        # 若右邊不是 Point，就交給 Python 決定如何處理這次比較。
...
@total_ordering
class Score:
    """只實作最少比較方法，其餘交給 @total_ordering 產生。"""
    ...
    def __lt__(self, other):
        # __lt__ 定義排序依據；有了它，sorted() 才知道怎麼排。
        return self.value < other.value
