...
"""
11005 hand-written 版本

此檔為較可讀的手寫版本，用較多註解與直觀變數名稱示範解法流程：
- `base_cost`: 計算某數在指定進位下的印刷成本。
- `main`: 解析題目輸入、逐一查詢每個數字在 2~36 進位下的成本，輸出最低成本的進位清單。

此檔僅為教學用途（可讀性高），功能與正式 `solution.py` 等價。
"""
