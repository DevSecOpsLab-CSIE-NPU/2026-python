...
def main() -> None:
	...
	target_script = test_dir.parent / "10038_AI.py"
	result_json = test_dir / "10038_test_results.json"
	result_txt = test_dir / "10038_test_results.txt"
