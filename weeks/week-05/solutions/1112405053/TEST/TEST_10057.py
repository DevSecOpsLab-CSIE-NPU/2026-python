...
TARGET_SCRIPT = BASE_DIR.parent / "10057_AI.py"
RESULT_FILE = BASE_DIR / "RESULT_10057.txt"


TEST_CASES = [
    {
        "name": "case-1: uppercase letter",
        "input": "ABC",
    },
    {
        "name": "case-2: lowercase letter",
        "input": "xyz",
    },
    {
        "name": "case-3: digit",
    ...
    {
        "name": "case-4: special symbol",
        "input": "!@#",
    },
    {
        "name": "case-5: space and others",
        "input": " hello",
    },
]
...
def main() -> None:
    lines: list[str] = []
    lines.append("=" * 60)
    lines.append(f"10057 測試時間: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    ...
    for index, case in enumerate(TEST_CASES, start=1):
        ...
        lines.append(f"輸入: {repr(case['input'])}")
