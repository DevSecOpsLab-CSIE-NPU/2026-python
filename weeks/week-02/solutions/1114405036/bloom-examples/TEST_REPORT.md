...
**路徑**: `solutions/1114405036/bloom-examples/`  
**測試日期**: 2026-03-12  
**測試環境**: Python 3.9.6
...
**檔案**: `tests/test_R05_priority_queue.py`
...
**檔案**: `tests/test_R07_ordered_dict.py`
...
**檔案**: `tests/test_R08_dict_minmax.py`
...
bloom-examples/
├── tests/
│   ├── test_R04_heapq.py          (10 個視覺化 heapq 用法)
│   ├── test_R05_priority_queue.py (10 個優先級隊列測試)
│   ├── test_R07_ordered_dict.py   (10 個有序字典測試)
│   └── test_R08_dict_minmax.py    (12 個字典操作測試)
└── TEST_REPORT.md                 (此報告)
```
...
這些示例代碼涵蓋了 Python collections 和 heapq 模組的關鍵用法。
