...
# The dataset may contain mojibake variants for the same admission method.
METHOD_ALIASES = {
...
def read_csv(filepath: str) -> list[dict]:
    """Read source CSV and return parsed rows with required fields."""
    rows: list[dict] = []
...
def write_json(data: dict, filepath: str) -> None:
    """Write result payload to JSON file."""
